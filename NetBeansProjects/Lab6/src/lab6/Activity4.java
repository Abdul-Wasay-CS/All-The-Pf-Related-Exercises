...
public class Activity4 {
    public static void main(String[] args) {
        ...
        System.out.println("The character at index 16 in sentence = "
        + sentence.charAt(16));
        ...
        System.out.println("sentence.subtring(7, 22) = \"" + sentence.substring(7, 22) + "\"");
        System.out.println("sentence.subtring(4, 10) = \"" + sentence.substring(4, 10) + "\"");
